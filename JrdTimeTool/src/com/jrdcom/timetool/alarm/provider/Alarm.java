...
public final class Alarm implements Parcelable {
    ...
    public static class Columns implements BaseColumns {
        ...
        public static final Uri CONTENT_URI =
                Uri.parse("content://com.jrdcom.timetool.alarm/alarm");
        ...
        public static final String[] ALARM_QUERY_COLUMNS = {
            ...
            ENABLED, VIBRATE, MESSAGE, ALERT, VOLUME, RINGTONE_PATH, ALERT_COUNT};
	    /*FR 548923- Neo Skunkworks - Paul Xu added - 001 End*/
        ...
        public static final int ALARM_ALERT_PARTH_INDEX = 10;
        /*FR 548923- Neo Skunkworks - Paul Xu added - 001 Begin*/
        public static final int ALARM_ALERT_COUNT_INDEX = 11;
        /*FR 548923- Neo Skunkworks - Paul Xu added - 001 End*/
    }
    //////////////////////////////
    ...
    public Alarm(Cursor c) {
        ...
        alert = c.getString(Columns.ALARM_ALERT_INDEX);
        volume = c.getInt(Columns.ALARM_VOLUME_INDEX);
        alertPath = c.getString(Columns.ALARM_ALERT_PARTH_INDEX);
        /*FR 548923- Neo Skunkworks - Paul Xu added - 001 Begin*/
        alertCount = c.getInt(Columns.ALARM_ALERT_COUNT_INDEX);
        /*FR 548923- Neo Skunkworks - Paul Xu added - 001 End*/
        
        // PR 417522 add by carongxing begin
        if(alert.equals("Silent")){
        	silent = true;
        }
        // PR 417522 add by carongxing end 
    }
    ...
    public Alarm(Parcel p) {
        ...
        silent = p.readInt() == 1;
        volume = p.readInt();
        alertPath = p.readString();
        /*FR 548923- Neo Skunkworks - Paul Xu added - 001 Begin*/
        alertCount = p.readInt();
        /*FR 548923- Neo Skunkworks - Paul Xu added - 001 End*/
    }
    ...
    public static final class DaysOfWeek {
		...
		private static String[] DAY_MAP_ES = new String[] { "Lunes", "Martes",
