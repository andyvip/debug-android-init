...
import com.jrdcom.timetool.alarm.AlarmDatabaseHelper;
...
public class AlarmProvider extends ContentProvider {
    ...
    static {
		sURLMatcher.addURI("com.jrdcom.timetool.alarm", "alarm", ALARMS);
		sURLMatcher.addURI("com.jrdcom.timetool.alarm", "alarm/#",ALARMS_ID);
    }
    ...
    public Cursor query(Uri url, String[] projectionIn, String selection,
        ...
        if (ret == null) {
        	MyLog.debug("Alarms.query: failed", AlarmProvider.class);
        } else {
    ...
    public int update(Uri url, ContentValues values, String where, String[] whereArgs) {
		...
		MyLog.debug("*** notifyChange() rowId: " + rowId + " url " + url,
				AlarmProvider.class);
