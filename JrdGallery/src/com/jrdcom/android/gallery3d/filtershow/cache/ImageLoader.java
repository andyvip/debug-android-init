...
package com.jrdcom.android.gallery3d.filtershow.cache;
...
import com.jrdcom.android.gallery3d.data.Exif;
...
import com.jrdcom.android.gallery3d.util.XmpUtilHelper;
...
public class ImageLoader {
    ...
    private void closeQuietly(InputStream input) {
        try {
            ...
            Log.e(LOGTAG, "closeQuietly Exception:" + ioe.getMessage());
            // ignore
        }
    }
    ...
    public boolean queryLightCycle360() {
        try {
            ...
            if (meta == null) {
                closeQuietly(is); // changed by jipu.xiong@tcl.com
                return false;
            }
