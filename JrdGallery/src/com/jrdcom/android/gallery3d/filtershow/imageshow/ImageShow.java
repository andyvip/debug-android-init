...
package com.jrdcom.android.gallery3d.filtershow.imageshow;
...
import com.jrdcom.android.gallery3d.filtershow.HistoryAdapter;
import com.jrdcom.android.gallery3d.filtershow.ImageStateAdapter;
import com.jrdcom.android.gallery3d.filtershow.PanelController;
...
import com.jrdcom.android.gallery3d.filtershow.ui.SliderController;
import com.jrdcom.android.gallery3d.filtershow.ui.SliderListener;
...
public class ImageShow extends View implements OnGestureListener,
    ...
    public void defaultDrawImage(Canvas canvas) {
        if(mProc){
            drawImage(canvas, mBeautyControl.getCurrentShowImage());
        }else {
            drawImage(canvas, getGeometryOnlyImage());
        }
        //drawPartialImage(canvas, getGeometryOnlyImage());
        drawPartialImage(canvas, mImageLoader.getOriginalBitmapLarge());//add by biao.luo for pr548601
    }
    ...
    public void setProcBitmap(boolean org) {
        this.mProc = org;
        invalidate();
    }
