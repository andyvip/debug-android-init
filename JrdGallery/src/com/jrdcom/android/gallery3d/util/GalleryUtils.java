...
import com.jrdcom.android.gallery3d.app.PackagesMonitor;
...
import com.jrdcom.example.joinpic.HAblum_Main;
...
public class GalleryUtils {
    ...
    private static final String CAMERA_LAUNCHER_NAME = "com.android.jrdcamera.CameraLauncher";
    ...
    public static void startJoinActivity(Context context) {
//        Intent intent = new Intent(context, ablum_main.class);
        Intent intent = new Intent(context, HAblum_Main.class);
        context.startActivity(intent);
    }
    //add by biao.luo end
    ...
    private static ArrayList<String> getItemList(
            ContentResolver contentResolver, Uri srcContentUri,
            String mWhereClauseForDelete, String[] mWhereClauseArgsForDelete) {
        ArrayList<String> list = new ArrayList<String>();
        Cursor cursor = null;
        try {
            cursor = contentResolver.query(srcContentUri, new String[]{FileColumns.DATA}, mWhereClauseForDelete, mWhereClauseArgsForDelete, null);
            if (cursor != null) {
    ...
    public static void deleteItems(ContentResolver contentResolver,
            Uri srcContentUri, String mWhereClauseForDelete,
            String[] mWhereClauseArgsForDelete) {
