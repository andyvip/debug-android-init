...
import com.jrdcom.android.gallery3d.anim.Animation;
import com.jrdcom.android.gallery3d.app.AbstractGalleryActivity;
import com.jrdcom.android.gallery3d.app.Log;
...
public class CropView extends GLView{
  ...
  //CR493910-lilei-begin
    private static final int COLOR_OUTLINE_TWO = 0xFFFFFF00;
  //CR493910-lilei-end
    ...
    private HashMap<String,Boolean> modes = new HashMap<String,Boolean>();
    private MotionEvent motionEvent;
    private float mWideAspectRatio;
    //CR493910-lilei-end
    private boolean IsSetAsWallpaper = true;
    ...
    public CropView(AbstractGalleryActivity activity) {
        ...
        mPaint.setColor(COLOR_OUTLINE_TWO);
        //CR493910-lilei-end
...
//    	}
    	//PR535147-lilei-end
    	mHighlightRectangle.moveEdges(motionEvent);
    }
    ...
    public void setAsWallpaper(boolean iswallpaper){
    	IsSetAsWallpaper = iswallpaper;
    }
    ...
    public class HighlightRectangle extends GLView {
        ...
        public void setInitRectangle() {
            ...
            //PR470523-lilei-begin
              //PR522286-lilei-begin
            mHighlightRect.set(0.5f - w, 0.5f - h, 0.5f + w, 0.5f + h);
            //mHighlightRect.set(0f, 0f, 1f, 1f);
            //PR522286-lilei-end
            //PR470523-lilei-end
        }
        ...
        public void moveEdges(MotionEvent event) {
          ...
          //PR540937-lilei-begin
            ...
            if(IsSetAsWallpaper){
            if(event != null){
             dx = (event.getX() - mReferenceX) / scale / mImageWidth;
             dy = (event.getY() - mReferenceY) / scale / mImageHeight;
            mReferenceX = event.getX();
            mReferenceY = event.getY();
            }else{
                dx = (float)((540.3127 - mReferenceX) / scale / mImageWidth);
                dy = (float)(914.41974 - mReferenceY) / scale / mImageHeight;
                mReferenceX = (float)540.3127;
                mReferenceY = (float)914.41974;
            }
            }
            else{
            dx = (event.getX() - mReferenceX) / scale / mImageWidth;
            ...
            if ((mMovingEdges & MOVE_BLOCK) != 0) {
              ...
              //CR493910-lilei-begin
                if (mAspectRatio != UNSPECIFIED) {
                	...
                	float targetRatio;
                	if(IsSetAsWallpaper){
                	if(msharedPreferences.getBoolean(KEY_IS_WIDE_MODE,true)){
                		//mAspectRatio = (float)1.0;
                		targetRatio = mWideAspectRatio * mImageHeight / mImageWidth;
                	}else{
                		targetRatio = mAspectRatio * mImageHeight / mImageWidth;
                	}
                	}else{
                     targetRatio = mAspectRatio * mImageHeight / mImageWidth;
                	}
      ...
      //PR474590-lilei-begin
        private void initSpotLightRatio(){
        	//PR521255-lilei-begin
           ...
           //PR533816-lilei-begin
           mWideAspectRatio = width > height ? (float) height * 2 / width : (float) width * 2 / height;
           //PR533816-lilei-end
           mAspectRatio = width > height ? (float)  height/ width : (float)  width/height;
            Point size = getDefaultDisplaySize(new Point());
            mSpotlightRatioX = (float) size.x / width;
            mSpotlightRatioY = (float) size.y / height;
          //PR521255-lilei-end
        }
        ...
        private void drawHighlightRectangle(GLCanvas canvas, RectF r) {   	 
           ...
           int orientation = mActivity.getResources().getConfiguration().orientation; 	       
            ...
            if (mSpotlightRatioX == 0 || mSpotlightRatioY == 0) {
            	...
            	//PR487906-Xiaowei.Xu-begin
            	initSpotLightRatio();            	
     	       //PR487906-Xiaowei.Xu-end
                ...
                //canvas.fillRect(r.left, r.top, r.width(), r.height(), 0x80000000);
            	 ...
            	 if (mSpotlightRatioX == 0 || mSpotlightRatioY == 0) {
         	       ...
         	       //PR487906-Xiaowei.Xu-end
         	     //PR521255-lilei-begin
                     float sy = r.width() * mSpotlightRatioX;
                     float sx = r.height() * mSpotlightRatioY;
                     float cx = r.centerX();
                     float cy = r.centerY();
                   //PR521255-lilei-end
                   //canvas.fillRect(cx - sx / 2, cy - sy / 2, sx, sy, Color.TRANSPARENT);
