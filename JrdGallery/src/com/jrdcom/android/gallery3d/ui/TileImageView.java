...
import com.jrdcom.android.gallery3d.app.GalleryContext;
import com.jrdcom.android.gallery3d.common.ApiHelper;
import com.jrdcom.android.gallery3d.common.LongSparseArray;
...
public class TileImageView extends GLView {
    ...
    void queueForUpload(Tile tile) {
        ...
        if (mTileUploader.mActive.compareAndSet(false, true)) {
            //PR942049 modify Gallery Force Close  by fengke at 2015.03.11 start
            // M: avoid JE when this view has been detached from root
            GLRoot root = getGLRoot();
            if (root != null) {
                root.addOnGLIdleListener(mTileUploader);
            }
            //PR942049 modify Gallery Force Close  by fengke at 2015.03.11 end
        }
    }
    ...
    public void drawTile(GLCanvas canvas,
        ...
        if (mScreenNail != null) {
            ...
            source.set(tx * scaleX, ty * scaleY, (tx + size) * scaleX,
                    (ty + size) * scaleY);
            //PR988345 modify for monkey test error by fengke at 2015.04.29 start
            try {
                mScreenNail.draw(canvas, source, target);
            } catch (Exception e) {
                Log.w(TAG, "GalleryChange Exception e = " + e);
            }
            //PR988345 modify for monkey test error by fengke at 2015.04.29 end
        }
    }
