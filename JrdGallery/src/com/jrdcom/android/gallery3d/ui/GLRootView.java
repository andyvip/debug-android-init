...
import com.jrdcom.android.gallery3d.util.MotionEventHelper;
import com.jrdcom.android.gallery3d.util.Profile;
...
public class GLRootView extends GLSurfaceView
    ...
    private void setSurfaceStereoMode(boolean surfaceStereoMode) {
        ...
        if (surfaceStereoMode) {
            stereoLayout = LAYOUT3D_SIDE_BY_SIDE;
        } else {
            stereoLayout = LAYOUT3D_DISABLED;
        }
