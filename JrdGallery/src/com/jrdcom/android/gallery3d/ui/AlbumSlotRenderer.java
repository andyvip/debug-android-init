...
import com.jrdcom.android.gallery3d.app.AlbumDataLoader;
...
import com.jrdcom.mediatek.gallery3d.videothumbnail.VideoThumbnailDirector;
/// @}
...
public class AlbumSlotRenderer extends AbstractSlotRenderer {
    ...
    public int renderSlot(GLCanvas canvas, int index, int pass, int width, int height) {
        ...
        /// M: Video thumbnail play @{
        if (!mVideoThumbnailDirector.renderThumbnail(entry, canvas, width, height)){
        /// @}
