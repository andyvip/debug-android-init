...
import com.jrdcom.android.gallery3d.data.DataSourceType;
...
public class AlbumSetSlidingWindow implements AlbumSetDataLoader.DataListener {
    ...
    //add by qjz for VideoPlayer NewUI 20130411 begin
    public  AlbumSetEntry [] getData() {
        return mData;
    }
	//add by qjz for VideoPlayer NewUI 20130411 end
    ...
    private class AlbumCoverLoader extends BitmapLoader implements EntryUpdater {
        ...
        protected Future<Bitmap> submitBitmapTask(FutureListener<Bitmap> l) {
            MediatekMMProfile.triggerAlbumSetPageDecodeScreenNail();
        ...
        @Override
        public void updateEntry() {
            MediatekMMProfile.startProfileAlbumSetPageUpdateCoverItem();
            ...
            MediatekMMProfile.stopProfileAlbumSetPageUpdateCoverItem();
