...
import com.jrdcom.android.gallery3d.ui.PhotoView.Size;
import com.jrdcom.android.gallery3d.util.GalleryUtils;
import com.jrdcom.android.gallery3d.util.RangeArray;
import com.jrdcom.android.gallery3d.util.RangeIntArray;
import com.jrdcom.android.gallery3d.ui.PhotoView.Size;
...
public class PositionController {
    ...
    // picture size above 1300W
    public static final float SCALE_LIMIT_ABOVE_1300W = 0.95f;
    // picture size between 1300W and 800W
    public static final float SCALE_LIMIT_ABOVE_800W = 0.98f;
    // picture size between 800W and 200W
    public static final float SCALE_LIMIT_ABOVE_200W = 1.25f;
    // picture size below 200w
    public static final float SCALE_LIMIT_BELOW_200W = 1.25f;
    ...
    private float getMaximalScale(Box b) {
        ...
        if (b.mImageW * b.mImageH < 1500000) {
            return SCALE_LIMIT;
        } else if (b.mImageW * b.mImageH < 13000000) {
            return 1.5f;
        } else {
            return 1.25f;
        }
