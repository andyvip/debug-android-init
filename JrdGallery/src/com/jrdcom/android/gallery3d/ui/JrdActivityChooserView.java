 ...
 * @hide
 */
public class JrdActivityChooserView extends ViewGroup implements ActivityChooserModelClient {
     ...
     */
    public JrdActivityChooserView(Context context) {
        this(context, null);
    }
     ...
     */
    public JrdActivityChooserView(Context context, AttributeSet attrs) {
     ...
     */
    public JrdActivityChooserView(Context context, AttributeSet attrs, int defStyle) {
        ...
        inflater.inflate(R.layout.jrd_activity_chooser_view, this, true);
    ...
    private void showPopupUnchecked(int maxActivityCount) {
        ...
        final boolean defaultActivityButtonShown = false;
        ...
        if (!popupWindow.isShowing()) {
            ...
            popupWindow.getListView().setContentDescription(mContext.getString(
                    com.android.internal.R.string.activitychooserview_choose_application));
        }
    }
    ...
    private ListPopupWindow getListPopupWindow() {
        if (mListPopupWindow == null) {
            ...
            mListPopupWindow.setAnchorView(JrdActivityChooserView.this);
                ...
                case ActivityChooserViewAdapter.ITEM_VIEW_TYPE_ACTIVITY: {
                    ...
                    if (mIsSelectingDefaultActivity) {
                        ...
                        if (launchIntent != null) {
                            //PR-520989 added by xiaowei.xu begin
                           // launchIntent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_WHEN_TASK_RESET);
                            //PR-520989 added by xiaowei.xu end
                ...
                case ITEM_VIEW_TYPE_FOOTER:
                    if (convertView == null || convertView.getId() != ITEM_VIEW_TYPE_FOOTER) {
                        convertView = LayoutInflater.from(getContext()).inflate(
                                R.layout.jrd_activity_chooser_view_list_item, parent, false);
                        convertView.setId(ITEM_VIEW_TYPE_FOOTER);
                        TextView titleView = (TextView) convertView.findViewById(R.id.title);
                        titleView.setText(mContext.getString(
                        		com.android.internal.R.string.activity_chooser_view_see_all));
                    }
                    return convertView;
                case ITEM_VIEW_TYPE_ACTIVITY:
