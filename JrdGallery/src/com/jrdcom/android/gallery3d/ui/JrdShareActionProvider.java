 ...
 * @see ActionProvider
 */
public class JrdShareActionProvider extends ActionProvider {

    /**
     * Listener for the event of selecting a share target.
     */
    public interface OnJrdShareTargetSelectedListener {
    ...
    private OnJrdShareTargetSelectedListener mOnJrdShareTargetSelectedListener;
     ...
     */
    public JrdShareActionProvider(Context context) {
        super(context);
        mContext = context;
    }
     ...
     */
    public void setOnJrdShareTargetSelectedListener(OnJrdShareTargetSelectedListener listener) {
        mOnJrdShareTargetSelectedListener = listener;
    ...
    public View onCreateActionView() {
        ...
        JrdActivityChooserView activityChooserView = new JrdActivityChooserView(mContext);
    ...
    public void onPrepareSubMenu(SubMenu subMenu) {
        ...
        if (collapsedActivityCount < expandedActivityCount) {
            ...
            SubMenu expandedSubMenu = subMenu.addSubMenu(Menu.NONE, collapsedActivityCount,
                    ...
                    mContext.getString(com.android.internal.R.string.activity_chooser_view_see_all));
    ...
    private void setActivityChooserPolicyIfNeeded() {
        if (mOnJrdShareTargetSelectedListener == null) {
            return;
        }
    ...
    /**
     * Policy that delegates to the {@link OnJrdShareTargetSelectedListener}, if such.
    ...
    private class ShareAcitivityChooserModelPolicy implements OnChooseActivityListener {
        ...
        public boolean onChooseActivity(ActivityChooserModel host, Intent intent) {
            if (mOnJrdShareTargetSelectedListener != null) {
                mOnJrdShareTargetSelectedListener.onJrdShareTargetSelected(
                        JrdShareActionProvider.this, intent);
            }
            if (intent != null) {
    ...
    /**
     * Boolean extra data key for {@link OnJrdShareTargetSelectedListener} intent, if app wants this intent
