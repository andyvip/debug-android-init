...
public abstract class MediaItem extends MediaObject {
    ...
    public String file_path;//PR434108-xiaobin.yang-001
    ...
    private static final BitmapPool sThumbPool =
            ...
            ? new BitmapPool(4)
            : null;
    private Bitmap mThumbnail=null;//add by qjz for newUI 2013-04-08
    public boolean isSelect = false;
    public boolean mCreateThumbnailDone = false;
    ...
    //add by qjz for Gallery newUI 2013-04-08 begin
    ...
    //add by qjz for Gallery newUI 2013-04-08 end
