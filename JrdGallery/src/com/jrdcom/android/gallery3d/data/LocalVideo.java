...
public class LocalVideo extends LocalMediaItem {
   ...
   // private static final int INDEX_STEREO_TYPE = 15; // for baseline upgrade leiming
    ...
    public int getSubType() {
        ...
        if (mIsDrmSupported && isDrm() && OmaDrmStore.DrmMethod.METHOD_FL != drm_method) {//PR511555-xiaobin-yang-001  //FR 576703 add by xiangchen 
            if (!hasDrmRights()) {
