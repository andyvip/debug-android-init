...
import com.jrdcom.android.gallery3d.util.IdentityCache;
...
public class Path {
    ...
    public Path getChild(String segment) {
        ...
        if (com.jrdcom.mediatek.gallery3d.util.MediatekFeature.isDrmSupported()) {
    ...
    //670797 clear old object denan.wang@tcl.com begin
