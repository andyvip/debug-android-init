...
/*      new ActionItem(FilterUtils.CLUSTER_BY_FACE, true, false, R.string.people,
    ...
    private class ClusterAdapter extends BaseAdapter {
        ...
        //add by qjz for Gallery NewUI 20130412
        public int groupIconId[]=new int[]{
            R.drawable.album,
            R.drawable.lacation,
            R.drawable.time
        };
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            if (convertView == null) {
                convertView = mInflater.inflate(R.layout.new_menu_item, parent, false);
            }
            TextView text = (TextView) convertView.findViewById(R.id.item_name);
            text.setText(sClusterItems[position].spinnerTitle);
            ImageView image = (ImageView) convertView.findViewById(R.id.item_icon);
            image.setImageResource(groupIconId[position]);
            //image.setBackgroundResource(groupIconId[position]);
            /*ImageView album = (ImageView) convertView
                    .findViewById(R.id.newalbum);
            if (position == 0) {
    ...
    //add by qjz for Gallery NewUI 20130412 begin
    public int getCurrentIndex() {
        switch (mCurrentIndex) {
        case 0:
            return FilterUtils.CLUSTER_BY_ALBUM;
        case 1:
            return FilterUtils.CLUSTER_BY_LOCATION;
        case 2:
            return FilterUtils.CLUSTER_BY_TIME;
        }
        return FilterUtils.CLUSTER_BY_ALBUM;
    }
    //add by qjz for Gallery NewUI 20130412 end
    ...
    public void showMultipleChoice(SelectionManager selectionManager) {
        if (mActionBar != null) {
            this.isMultipleChoice = true;
            this.selectionManager = selectionManager;
            if (mMultipleChoiceModeAdapter == null) {
                mMultipleChoiceModeAdapter = new MultipleChoiceModeAdapter();
            }
            mActionBar.setListNavigationCallbacks(mMultipleChoiceModeAdapter, this);
            mActionBar.setNavigationMode(ActionBar.NAVIGATION_MODE_LIST);
        }
    }
    
    public void updateSelectView() {
        mMultipleChoiceModeAdapter.notifyDataSetChanged();
    }
    
    private SelectionManager selectionManager;
    private MultipleChoiceModeAdapter mMultipleChoiceModeAdapter;
    private boolean isMultipleChoice = false;
    private class MultipleChoiceModeAdapter extends BaseAdapter {
        @Override
        public int getCount() {
            return 1;
        }
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            TextView view = (TextView) convertView;
            view.setText(" " + selectionManager.getSelectedCount() + " "
                    + mActivity.getResources().getString(R.string.selected));
            return convertView;
        }
        ...
        public View getDropDownView(int position, View convertView, ViewGroup parent) {
            if (convertView == null) {
                convertView = mInflater.inflate(R.layout.action_multiple_bar_text,
                        parent, false);
            }
            TextView view = (TextView) convertView;
            if (selectionManager.inSelectAllMode()) {
            ...
            convertView.setOnClickListener(new OnClickListener() {
                ...
                public void onClick(View v) {
                  ...
                  mMultipleChoiceModeAdapter.notifyDataSetInvalidated();
                  mMultipleChoiceModeAdapter.notifyDataSetChanged();
                }
            });
            return convertView;
