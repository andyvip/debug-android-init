...
public interface ControllerOverlay {
  ...
  interface Listener {
    ...
    boolean onIsRTSP();
    void onReplay();
    void onChangeLoopMode();//add by qjz for New UI
	void onShowSeekToView(int seek);//add by qjz for New UI 2013-03-15
	void onSetSeekViewShow(boolean isShow);//add by qjz for New UI 2013-03-15
