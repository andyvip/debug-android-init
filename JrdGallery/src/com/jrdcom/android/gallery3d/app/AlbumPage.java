...
import com.jrdcom.android.gallery3d.data.MtpDevice;
import com.jrdcom.android.gallery3d.data.Path;
import com.jrdcom.android.gallery3d.ui.ActionModeHandler;
import com.jrdcom.android.gallery3d.ui.ActionModeHandler.ActionModeListener;
import com.jrdcom.android.gallery3d.ui.AlbumSlotRenderer;
import com.jrdcom.android.gallery3d.ui.DetailsHelper;
import com.jrdcom.android.gallery3d.ui.DetailsHelper.CloseListener;
import com.jrdcom.android.gallery3d.ui.FadeTexture;
...
import com.jrdcom.android.gallery3d.ui.PhotoFallbackEffect;
import com.jrdcom.android.gallery3d.ui.RelativePosition;
import com.jrdcom.android.gallery3d.ui.SelectionManager;
import com.jrdcom.android.gallery3d.ui.SlotView;
...
public class AlbumPage extends ActivityState implements GalleryActionBar.ClusterRunner,
    ...
    private boolean multipleChoice = false;// add by yaping.liu for support multiple choice
    ...
    protected void onCreate(Bundle data, Bundle restoreState) {
        ...
        multipleChoice = data.getBoolean(Gallery.MULTIPE_CHOICE, false);// add by yaping.liu for
        if (multipleChoice) {
    ...
    protected boolean onCreateActionBar(Menu menu) {
        ...
        if (mGetContent) {
            // modify start by yaping.liu for support multiple choice
            if (multipleChoice) {
                inflator.inflate(R.menu.custom_pickup, menu);
                mActionBar = actionBar;
                actionBar.showMultipleChoice(mSelectionManager);
            } else {
             ...
             // modify end by yaping.liu for support multiple choice
        } else {
        ...
        switch (item.getItemId()) {
            ...
            case R.id.action_ok:
                ...
                for (Path path : expandedPaths) {
                    Uri contentUri = dm.getContentUri(path);
                    uris.add(contentUri);
                }
                
                intent.putParcelableArrayListExtra("paths", uris);
    ...
    private boolean startMtkCropFlow(final MediaItem item) {
        ...
        Activity activity = (Activity) mActivity;
        Uri uri = dm.getContentUri(item.getPath());
        //modify by jianxin.wei for PR855094 begin
        ...
        //Intent intent = new Intent(CropImage.ACTION_CROP, uri);
        //add by biao.luo for pr501659 begin
        //add extra data
        //if(getData()!=null)
        ...
        Intent intent = null;
        if (cropForWallpaper) {
        	intent = new Intent(CropImage.ACTION_CROP, uri, activity, CropImage.class);
        } else {
        	intent = new Intent(CropImage.ACTION_CROP, uri);
        }
        if(getData()!=null)
        intent.putExtras(getData());
        ...
        //modify by jianxin.wei for PR855094 end
