...
/* date    | author       | PR #                            |                                 */
/*=========|==============|==========================================|======================================*/
/* 09/04/13| Xingwang Yang | PR511680-YangXingwang-001  |Gallery displays black screen when delete the last picture         */
/*=========|==============|============================|======================================*/
...
import com.jrdcom.android.gallery3d.data.LocalMediaItem;
...
import com.jrdcom.android.gallery3d.ui.ScreenNail;
import com.jrdcom.android.gallery3d.ui.SynchronizedHandler;
import com.jrdcom.android.gallery3d.ui.TileImageViewAdapter;
import com.jrdcom.android.gallery3d.ui.TiledScreenNail;
import com.jrdcom.android.gallery3d.ui.TiledTexture;
...
import com.jrdcom.mediatek.gallery3d.gif.GifDecoderWrapper;
import com.jrdcom.mediatek.gallery3d.stereo.StereoHelper;
import com.jrdcom.mediatek.gallery3d.ui.MtkBitmapScreenNail;
...
public class PhotoDataAdapter implements PhotoPage.Model {
    ...
    private boolean mIsSendBroadCast = false;// add by yaping.liu for pr480845
...
//        sImageFetchSeq[k++] = new ImageFetch(-1, BIT_FULL_IMAGE);
    ...
    private void fireDataChange() {
        ...
        //PR653272-taoli-begin 001
        if ((mSize - 1 - mCurrentIndex) == -1) {// the last one
        if (mReloadTask != null)
        mReloadTask.notifyDirty();
        }
        //PR653272-taoli-end 001
        ...
        if (isCamera(0)) {
            ...
            // add start by yaping.liu for pr480845
            MtkLog.d(TAG, "enterCameraPreview mIsSendBroadCast: " + mIsSendBroadCast);
            if (mIsSendBroadCast) {
                mIsSendBroadCast = false;
                Intent intent =new Intent();
                intent.setAction("com.jrdcom.CAMERA_OPEN");
                mActivity.sendBroadcast(intent);
            }
            // add end by yaping.liu for pr480845
        }
        MediatekMMProfile.stopProfilePhotoPageFireDataChange();
    }
...
//        public Bitmap[] mpoFrames;
    ...
    private class ReloadTask extends Thread {
        ...
        private void updateLoading(boolean loading) {
            ...
            mIsLoading = loading;
            //delete by wanwan.ye PR550802
//            mDirty = true; //PR511680-YangXingwang-001
    ...
    private static class OriginScreenNailJob 
        ...
        public ScreenNail run(JobContext jc) {
            ...
            */
            ...
            if (null == dataBundle||jc.isCancelled()) {//modified by qjz for PR459969
                return null;
            }
