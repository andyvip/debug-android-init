...
import com.jrdcom.android.gallery3d.ui.AlbumSlidingWindow;
...
import com.jrdcom.mediatek.gallery3d.videothumbnail.LoadingMonitor.LoadingListener;

import android.graphics.SurfaceTexture;
import android.util.Log;

public class VideoThumbnailDirector {
    private static final String TAG = "VideoThumbnailDirector";
...
//        mContentEnd = mDataWindow.getContentEnd();
    ...
    private boolean isStaticThumbnailDone() {        
        AlbumSlidingWindow.AlbumEntry entry;
        for (int i = mActiveStart; i < mActiveEnd; i++) {
            ...
            if (entry.content == null || entry.isWaitDisplayed) {
               return false;
            }
        }
        return true;
