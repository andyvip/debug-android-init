...
import com.jrdcom.mediatek.gallery3d.ext.IImageOptions;
import com.jrdcom.mediatek.gallery3d.ext.ImageOptions;
import com.mediatek.pluginmanager.Plugin;
import com.mediatek.pluginmanager.PluginManager;

import com.jrdcom.android.gallery3d.app.AlbumSetPage;
import com.jrdcom.android.gallery3d.app.PickerActivity;
...
import com.jrdcom.mediatek.gallery3d.data.RegionDecoder;
    ...
    public static void drawWidgetImageTypeOverlay(Context context, Uri uri, Bitmap bitmap) {
        ...
        if (c != null) {
            if (c.moveToFirst()) {
                ...
                //stereoType = c.getInt(1); // for baseline upgrade leiming
            }
            c.close();
        }
