 ...
 */
package com.jrdcom.mediatek.gallery3d.mpo;
...
// for baseline upgrade leiming
    ...
    public static String getMavWhereClause(int mavInclusion) {
        ...
        if ((mavInclusion & MediatekFeature.EXCLUDE_MPO_MAV) !=0) {
            //whereClause =  Images.Media.MPO_TYPE + "!=" + IMpoDecoder.MTK_TYPE_MAV; // for baseline upgrade leiming
            whereClause =  FileColumns.MIME_TYPE + "!='" + MPO_MIME_TYPE + "'";     // for baseline upgrade leiming
        }
        return whereClause;
    }
}
