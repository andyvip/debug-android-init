...
public class StereoVideoHooker extends MovieHooker {
    private static final String TAG = "StereoVideoHooker";
    ...
    //private static final String COLUMN_STEREO_TYPE = MediaStore.Video.Media.STEREO_TYPE; // for baseline upgrade leiming
    ...
    public void setStereoType(final int stereoType) {
        ...
        final int flag = (isStereo3D(stereoType) ? GLRootView.LAYOUT3D_SIDE_BY_SIDE
                : GLRootView.LAYOUT3D_DISABLED);
