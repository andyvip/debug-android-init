...
import com.jrdcom.android.gallery3d.app.MovieActivity;
import com.jrdcom.mediatek.gallery3d.ext.ActivityHookerGroup;
import com.jrdcom.mediatek.gallery3d.ext.IActivityHooker;
import com.jrdcom.mediatek.gallery3d.ext.IMovieDrmExtension;
import com.jrdcom.mediatek.gallery3d.ext.IMovieExtension;
import com.jrdcom.mediatek.gallery3d.ext.IMovieStrategy;
import com.jrdcom.mediatek.gallery3d.ext.MovieDrmExtension;
import com.jrdcom.mediatek.gallery3d.ext.MovieExtension;
import com.jrdcom.mediatek.gallery3d.ext.MovieStrategy;
...
public class ExtensionHelper {
    ...
    public static IActivityHooker getHooker(final Context context) {
       ...
       /* if (com.mediatek.common.featureoption.FeatureOption.MTK_S3D_SUPPORT) { // for baseline upgrade leiming
