...
import com.mediatek.storage.StorageManagerEx;//fengke add
...
*/
    ...
    private static void initializeHiddenFolders() {
        ...
        Log.d(TAG,"initialize:StorageManagerEx.getDefaultPath()="+StorageManagerEx.getDefaultPath());//fengke change
    ...
    private static Uri createAndInsert(JobContext jc, Context context,Uri origUri,
        ...
        String directPath = StorageManagerEx.getDefaultPath() +
                                STEREO_CONVERTED_TO_2D_FOLDER;//fengke change
